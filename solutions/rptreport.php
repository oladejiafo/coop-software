...
else if (trim($cmbReport)=="Verification Report")
{
  ...
  else if (trim($cmbTable)=="Yearly")
  {
   ...
   $limit      = 15; 
   $page=$_GET['page'];
   $query_count    = "SELECT * FROM `Sales` WHERE `Company` ='" .$_SESSION['company']. "' AND  " . $val;     
   ...
   $result = mysqli_query ($conn,"SELECT `Stock Code`, `Stock Name`,`Sales Date`, `Qnty Sold`, `Unit Cost`, `Total Cost`, `Paid` From `sales` WHERE `Company` ='" .$_SESSION['company']. "' AND  " . $val . " order by `Stock Code` LIMIT $limitvalue, $limit"); 
...
<?php
 ...
 else if ($cmbReport == "Individual Revenue Report")
 {
  ...
  else if (trim($cmbTable)=="Yearly")
  {
   ...
   $resul = mysqli_query ($conn,"SELECT DISTINCT concat(`Dob_Day`,'/',`DoB_Month`,'/',`DoB_Year`) as date From `revenue` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Command`='" . $filter2 . "' and " . $val); 
   while(list($dat)=mysqli_fetch_row($resul)) 
   {	

   $result = mysqli_query ($conn,"SELECT `Amount`,`Pending` From `revenue` WHERE `Company` ='" .$_SESSION['company']. "' AND  (concat(`Dob_Day`,'/',`DoB_Month`,'/',`DoB_Year`))='" . $dat . "' and `Command`='" . $filter2 . "' and " . $val); 
   ...
   { 
    ...
    while(list($amtpaid,$amtpend)=mysqli_fetch_row($result)) 
    {
      ...
      $rest = mysqli_query ($conn,"SELECT sum(`Amount`)as Amount,sum(`Pending`) as Pending From `revenue` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Command`='" . $filter . "' and " . $val); 
 ...
 else if ($cmbReport == "All Revenue Report")
 {
  ...
  else if (trim($cmbTable)=="Yearly")
  {
   ...
   $resul = mysqli_query ($conn,"SELECT distinct concat(`Dob_Day`,'/',`DoB_Month`,'/',`DoB_Year`) as date From `revenue` WHERE `Company` ='" .$_SESSION['company']. "' AND  " . $val); 
   while(list($dat)=mysqli_fetch_row($resul)) 
   {	
      echo "<TR><TH align='left' colspan='5'><b>" . strtoupper($dat) . "</b></TH></TR>";

   $reslt = mysqli_query ($conn,"SELECT distinct `Command` From `revenue` WHERE `Company` ='" .$_SESSION['company']. "' AND  (concat(`Dob_Day`,'/',`DoB_Month`,'/',`DoB_Year`))='" . $dat . "' and " . $val); 
   while(list($cmd)=mysqli_fetch_row($reslt)) 
   {	      
   $result = mysqli_query ($conn,"SELECT `Amount`,`Pending` From `revenue` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Command`='" . $cmd . "' and (concat(`Dob_Day`,'/',`DoB_Month`,'/',`DoB_Year`))='" . $dat . "' and " . $val); 
   ...
   { 
    ...
    while(list($amtpaid,$amtpend)=mysqli_fetch_row($result)) 
    {
      ...
      $rest = mysqli_query ($conn,"SELECT sum(`Amount`)as Amount,sum(`Pending`) as Pending From `revenue` WHERE `Company` ='" .$_SESSION['company']. "' AND  (concat(`Dob_Day`,'/',`DoB_Month`,'/',`DoB_Year`))='" . $dat . "' and " . $val); 
      $row = mysqli_fetch_array($rest);
      ...
      $rest2 = mysqli_query ($conn,"SELECT sum(`Amount`)as Amount,sum(`Pending`) as Pending From `revenue` WHERE `Company` ='" .$_SESSION['company']. "' AND  " . $val); 
...
*/
 ...
 else if ($cmbReport == "Non-Moving Stock Report")
 {
  ...
  else if (trim($cmbTable)=="Yearly")
  {
   ...
   $result = mysqli_query ($conn,"SELECT `Stock Code`, `Stock Name`,`Sales Date`, `Qnty Sold`, `Unit Cost`, `Total Cost`, `Paid` From `sales` WHERE `Company` ='" .$_SESSION['company']. "' AND  " . $val . " order by `Stock Code`"); 
