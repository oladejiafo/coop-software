...
?>
				...
				<div class="col-md-4 w3ls_footer_grid_left con"  style="background-color:003300; height:120px; margin-top:30px;margin-right:10px">
					<div>
						<b class="fa fa-pencil">
						<font color="#fff"  style="font-size:16px;">Backup/Restore</font></b>
					</div><br>
					<p style="line-height: 22px"><font color="#fff" style="font-size: 9pt" face="Verdana">
					Use this to backup or to restore.</font></p>
<?php
   echo "<br><h4><a href ='backmeup.php'><font  style='font-size:15px;'> Backup/Restore </font></a></h4>";
?>
				</div>
				<div class="col-md-4 w3ls_footer_grid_left con"  style="background-color:#999999; height:120px; margin-top:30px;margin-right:10px">
					<div>
						<b class="fa fa-pencilx">
						<font color="#fff"  style="font-size:16px;"></font></b>
					</div>
					<p style="line-height: 22px"><font color="#fff" style="font-size: 9pt" face="Verdana">
					</font></p>
<?php
   echo "<br><h4><a href ='#'><font  style='font-size:15px;'></font></a></h4>";
?>
				</div>
				<div class="col-md-4 w3ls_footer_grid_left con"  style="background-color:#f9fbfd; height:120px; margin-top:30px">
					<div>
						<b class="fa fa-pencilx">
						<font color="#fff"  style="font-size:16px;"></font></b>
					</div>
