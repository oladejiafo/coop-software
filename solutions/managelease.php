...
$sql="SELECT * FROM `lease application` WHERE `Company` ='" .$_SESSION['company']. "' AND  `ID`='$id'";
...
<div align="center">
	<table border="0" bordercolor='#003300' width="100%" cellspacing="1" bgcolor="#EFEFEF" id="table1" style="background: url(images/bggx4.png) no-repeat center; background-color:#EFEFEF"">
		<tr align='center'>
 <td bgcolor="#000000"><b>
  <font face="Verdana" color="#FFFFFF" style="font-size: 16pt">Lease Application Manager</font></b>
 </td>
</tr>
		<tr>
			<td>
...
<form method="post" action="lshandle.php">
<div align="center">
...
<legend><b><i><font style="height:35; font-size: 13pt" face="Tahoma" color="green">Bank/Lease Details</font></i></b></legend>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="AutoNumber1">
    ...
    <tr>
      ...
      <td align='left' height='80'> 
       <font color='red'>Bank/Lease Info Remarks:</font>
      </td>
      <td align='left' height='80'> 
...
<legend><b><i><font style="height:35; font-size: 13pt" face="Tahoma" color="green"></font></i></b></legend>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="AutoNumber1">
    ...
    <tr>
      ...
      <td colspan=1 align='left' height='80'> <input name="submit" type="submit" value="Disapprove Lease" align="top" style="height:35; color:#008000; font-size: 15pt" onclick="return confirm('Are you sure you want to Disapprove?');"></td>
      <td colspan=1 align='left' height='80'> <input name="submit" type="submit" value="Approve Lease" align="top" style="height:35; color:#008000; font-size: 15pt" onclick="return confirm('Are you sure you want to Approve?');"></td>
    </tr>
  </table>
 </fieldset>
</div>
