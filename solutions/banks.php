...
<TABLE width='100%' border='1' cellpadding='1' cellspacing='1' align='center' bordercolor="#005B00">
 ...
 $limitvalue = $page * $limit - ($limit);  
    ...
    $query="SELECT concat(`Dob_Year`,'/',`DoB_Month`,'/',`DoB_Day`) as date,Command,Amount,Bank,`Amount Remitted`,`ID`,`Confirmed` FROM `Revenue` WHERE `Company` ='" .$_SESSION['company']. "' order by `DoB_Day`,`DoB_Year` desc LIMIT $limitvalue, $limit";
