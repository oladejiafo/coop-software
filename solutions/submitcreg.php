...
###### 
        ...
        header("location:cregister.php?acctno=$acctno&tval=$tval&redirect=$redirect");
      }
      else
      {
...
##########################
        ...
        header("location:cregister.php?tval=$tval&redirect=$redirect");
       }
      }
      else
      {
        $tval="Please enter details before saving.";
        header("location:cregister.php?id=$id&tval=$tval&redirect=$redirect");
      }
      break;
     case 'Remove Pix':
      {
        ...
        header("location:cregister.php?acctno=$acctno&id=$id&tval=$tval&redirect=$redirect");
      }
      break;
...
######
        ...
        header("location:cregister.php?grp=$group&brch=$brch&acctno=$acctno&tvalg=$tval&redirect=$redirect");
      }
      else
      {
        $tval="Please enter Details before modifying.";
        header("location:cregister.php?grp=$group&brch=$brch&idgx=1&idg=$idg&acctno=$acctno&tvalg=$tval&redirect=$redirect");
      }
      break;
     case 'Add':
      if (Trim($acctno) != "" && Trim($name1) != "")
...
######
      ...
      {
        $tval="Please enter details before saving.";
        header("location:cregister.php?acctno=$acctno&grp=$group&brch=$brch&id=$id&idg=$idg&idgx=1&tvalg=$tval&redirect=$redirect");
      }
      break;
     case 'Remove':
      {
       ...
       $result_delete = mysqli_query($conn,$query_delete);          
        ...
        $tval="Your record has been deleted.";
        header("location:cregister.php?acctno=$acctno&grp=$group&brch=$brch&id=$id&tvalg=$tval&redirect=$redirect");
      }
      break;

     case 'Cancel':
      {
        header("location:cregister.php?acctno=$acctno&grp=$group&brch=$brch&redirect=$redirect");
      }
      break;
##################################################################################
     ...
     case 'Continue':
      {
        header("location:cregister.php?grp=$group&brch=$brch&redirect=$redirect");
      }
      break;
   }
 }
