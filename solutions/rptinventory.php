...
<?php
 ...
 if ($filter=="None" or $filter=="")
 {
  ...
  {
   $result = mysqli_query ($conn,"SELECT `Stock Code`, `Stock Name` , `Category`, `Location`,`Reorder Level`,`Unit Cost`,`Units in Stock`  From `Stock` WHERE `Company` ='" .$_SESSION['company']. "' Order By `Location`,`Category`,`Stock Code`"); 
  ...
  {  
   $result = mysqli_query ($conn,"SELECT `Stock Code`, `Stock Name` , `Category`, `Location`,`Reorder Level`,`Unit Cost`,`Units in Stock`  From `Stock` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Location`='" . $filter . "' order by `Location`,`Category`,`Stock Code`"); 
  ...
  {     
   $result = mysqli_query ($conn,"SELECT `Stock Code`, `Stock Name` , `Category`, `Location`,`Reorder Level`,`Unit Cost`,`Units in Stock`  From `Stock` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Stock Name`='" . $filter . "' order by `Location`,`Category`,`Stock Code`"); 
  ...
  {  
   $result = mysqli_query ($conn,"SELECT `Stock Code`, `Stock Name` , `Category`, `Location`,`Reorder Level`,`Unit Cost`,`Units in Stock`  From `Stock` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Category`='" . $filter . "' order by `Location`,`Category`,`Stock Code`"); 
  ...
  {  
   $result = mysqli_query ($conn,"SELECT `Staff Number`,  `Firstname` , `Surname`, `Sex`,`Present Rank`,`Barrdate`,`DoB`,`First Appt`,`Present Appt`,`State`,`LGA`,`Qualification`, `Present Location`, `Position` From `Staff`  WHERE `Company` ='" .$_SESSION['company']. "' AND  `Staff Number` like '" . $filter . "%' order by `Level` desc,`Present Appt` desc,`staff number`"); 
