...
<TABLE width='100%' border='1' cellpadding='1' cellspacing='1' align='center' bordercolor="#ccCCcc" id="table2">
 <?php
   ...
   {	
       ...
       $result01 = mysqli_query ($conn,"SELECT sum(`Amount`) as AMT01, `Date` FROM `loan payment` WHERE `Company` ='" .$_SESSION['company']. "' AND  ($val01) and `Loan ID` = '$id' and `Account Number`='$acctno' group by `Date`"); 
       ...
       $result02 = mysqli_query ($conn,"SELECT sum(`Amount`) as AMT02, `Date` FROM `loan payment` WHERE `Company` ='" .$_SESSION['company']. "' AND  ($val02) and `Loan ID` = '$id' and `Account Number`='$acctno' group by `Date`"); 
       ...
       $result03 = mysqli_query ($conn,"SELECT sum(`Amount`) as AMT03, `Date` FROM `loan payment` WHERE `Company` ='" .$_SESSION['company']. "' AND  ($val03) and `Loan ID` = '$id' and `Account Number`='$acctno' group by `Date`"); 
       ...
       $result04 = mysqli_query ($conn,"SELECT sum(`Amount`) as AMT04, `Date` FROM `loan payment` WHERE `Company` ='" .$_SESSION['company']. "' AND  ($val04) and `Loan ID` = '$id' and `Account Number`='$acctno' group by `Date`"); 
       $row04 = mysqli_fetch_array($result04);
       $amt04=$row04['AMT04'];

       $val05="date(`Date`) >'" . date('Y-m-d', strtotime('+120 day',strtotime($ldate))) . "'";
       $result05 = mysqli_query ($conn,"SELECT sum(`Amount`) as AMT05, `Date` FROM `loan payment` WHERE `Company` ='" .$_SESSION['company']. "' AND  ($val05) and `Loan ID` = '$id' and `Account Number`='$acctno' group by `Date`"); 
