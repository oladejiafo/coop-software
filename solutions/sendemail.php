<?php
    ...
    $to         = 'info@waltergates.com';

    $email_template = 'simple.html';

    $subject    = strip_tags($_POST['req']);
    ...
    if ( mail( $to, $subject, $contents, $headers ) ) {
        ...
        $result = array( 'response' => 'error', 'message'=>'<strong>Oppss!</strong> Can\'t Send Mail. Check Internet Connection'  );
    }

    //echo json_encode( $result );

//    die;
header("location:contact.php?tval=Message Sent&redirect=$redirect");