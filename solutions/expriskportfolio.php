...
$phn=$rw['Phone'];
 ...
 $filename = "riskportfolio_" . date('Ymd') . $filter . ".xls";
...
<tr><td colspan=1 width='260'><h2><left>RISKY PORTFOLIO REPORT</left></h2></td></tr>
</table>
<div align="left">
...
#   $result = mysqli_query ($conn,"SELECT `ID`,`Account Number`, `Loan Amount`, `Loan Date`, `Loan Duration`, `Payment todate`, `Balance`,`Total Interest` FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance` > 0 and `Loan Status`='Active' LIMIT $limitvalue, $limit"); 
...
#   while(list($id,$acctno,$lamount,$ldate,$lduration,$ptd,$bal,$int)=mysqli_fetch_row($result)) 
   {	
       $sqlt="SELECT count(`ID`) as nos FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0";
       ...
       $sqlt1="SELECT count(`ID`) as nos FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCL1";
       ...
       $sqlt2="SELECT count(`ID`) as nos2 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCL2";
       ...
       $sqlt3="SELECT count(`ID`) as nos3 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCL3";
       ...
       $sqlt4="SELECT count(`ID`) as nos4 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCL4";
       ...
       $sqlt5="SELECT count(`ID`) as nos FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCL5";
...
################################################################################################
       $sqlt="SELECT sum(`Balance`) as balance FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0";
       $resultt = mysqli_query($conn,$sqlt) or die('Could not look up user data; ' . mysqli_error());
       $rowt = mysqli_fetch_array($resultt);
       ...
       $sqlt1="SELECT sum(`Balance`) as balance1 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCLB1";
       $resultt1 = mysqli_query($conn,$sqlt1) or die('Could not look up user data; ' . mysqli_error());
       $rowt1 = mysqli_fetch_array($resultt1);
       ...
       $sqlt2="SELECT sum(`Balance`) as balance2 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCLB2";
       $resultt2 = mysqli_query($conn,$sqlt2) or die('Could not look up user data; ' . mysqli_error());
       $rowt2 = mysqli_fetch_array($resultt2);
       ...
       $sqlt3="SELECT sum(`Balance`) as balance3 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCLB3";
       $resultt3 = mysqli_query($conn,$sqlt3) or die('Could not look up user data; ' . mysqli_error());
       $rowt3 = mysqli_fetch_array($resultt3);
       ...
       $sqlt4="SELECT sum(`Balance`) as balance4 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCLB4";
       $resultt4 = mysqli_query($conn,$sqlt4) or die('Could not look up user data; ' . mysqli_error());
       $rowt4 = mysqli_fetch_array($resultt4);
       ...
       $sqlt5="SELECT sum(`Balance`) as balance5 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCLB5";
       $resultt5 = mysqli_query($conn,$sqlt5) or die('Could not look up user data; ' . mysqli_error());
       $rowt5 = mysqli_fetch_array($resultt5);
...
################################################################################################
       $sqlt="SELECT sum(`PBalance`) as lamt FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0";
       $resultt = mysqli_query($conn,$sqlt) or die('Could not look up user data; ' . mysqli_error());
       $rowt = mysqli_fetch_array($resultt);
       ...
       $sqlt1="SELECT sum(`PBalance`) as lamt1 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCLA1";
       $resultt1 = mysqli_query($conn,$sqlt1) or die('Could not look up user data; ' . mysqli_error());
       $rowt1 = mysqli_fetch_array($resultt1);
       ...
       $sqlt2="SELECT sum(`PBalance`) as lamt2 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCLA2";
       $resultt2 = mysqli_query($conn,$sqlt2) or die('Could not look up user data; ' . mysqli_error());
       $rowt2 = mysqli_fetch_array($resultt2);
       ...
       $sqlt3="SELECT sum(`PBalance`) as lamt3 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCLA3";
       $resultt3 = mysqli_query($conn,$sqlt3) or die('Could not look up user data; ' . mysqli_error());
       $rowt3 = mysqli_fetch_array($resultt3);
       ...
       $sqlt4="SELECT sum(`PBalance`) as lamt4 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCLA4";
       $resultt4 = mysqli_query($conn,$sqlt4) or die('Could not look up user data; ' . mysqli_error());
       $rowt4 = mysqli_fetch_array($resultt4);
       ...
       $sqlt5="SELECT sum(`PBalance`) as lamt5 FROM `loan` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Balance`>0 and $valCLA5";
       $resultt5 = mysqli_query($conn,$sqlt5) or die('Could not look up user data; ' . mysqli_error());
       $rowt5 = mysqli_fetch_array($resultt5);
