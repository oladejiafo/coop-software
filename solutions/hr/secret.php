...
$sql="SELECT `staff`.`Staff Number`,`staff`.Surname,`staff`.Firstname,`staff`.Dept,`staff`.`Present Rank`,`staff`.Level,`staff`.Step, 
       `warning`.`Date`,`warning`.`Action`, `warning`.`Reference`,`warning`.`Issued By`,`warning`.`Remark` FROM staff left join `warning` on `staff`.`Staff Number`=`warning`.`Staff Number` WHERE `staff`.`Staff Number`='$SNO'";
...
<div align="left">
<b><i><font size="3" face="Verdana" color="#008000">[WARNINGS]</font></i></b>
...
<?php
    echo "<TR><TH><b><u>Date </b></u>&nbsp;</TH><TH><b><u>Action </b></u>&nbsp;</TH><TH><b><u>Reference </b></u>&nbsp;</TH><TH><b><u>Issued By </b></u>&nbsp;</TH><TH><b><u>Remark </b></u>&nbsp;</TH></TR>";

    $query="SELECT `Date`,`Action`, `Reference`,`Issued By`,`Remark`,`Staff Number` FROM `warning` WHERE `Staff Number`='$SNO'";
    $result=mysql_query($query);

    while(list($date,$warning,$reference,$issuedby,$remark,$serviceNo)=mysql_fetch_row($result))
    {
     echo "<TR><TH><a href = 'Warning.php?RNO=" .$reference . "'> $date </a> &nbsp;</TH><TH>$warning &nbsp;</TH>
      <TH>$reference &nbsp;</TH><TH>$issuedby &nbsp;</TH><TH>$remark &nbsp;</TH></TR>";
    }
 ?>
</Table>
<p>
<TABLE width='30%' border='1' cellpadding='1' cellspacing='0' align='center' bordercolor="#005B00">
  ...
  <?php
     echo "<TR>
               <TH><a href ='warning.php'> Add New Warning </a>&nbsp;</TH>
           </TR>"; 
  ?>
</TABLE> 
 </fieldset>
