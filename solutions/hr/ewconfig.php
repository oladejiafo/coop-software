...
define("HOST", "64.71.229.253", TRUE);
define("PORT", 3306, TRUE);
define("USER", "fcscng_fcsc", TRUE);
define("PASS", "asdf1234", TRUE);
define("DB", "fcscng_fcsc", TRUE);
...
define("EW_PROJECT_VAR", "project1", TRUE); // Project Var
...
define("EW_RANDOM_KEY", "SjxNA%KD2HQ901d#", TRUE);
