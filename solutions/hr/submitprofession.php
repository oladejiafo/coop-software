 ...
 if (isset($_POST['submit']))
 {
   switch ($_POST['submit'])
   {
     case 'Update':
      if (Trim($profession) != "")
      {
        $query_update = "UPDATE `profession` SET `Profession`='$profession' WHERE `Profession` = '$profession';";
     ...
     case 'Save':
      if (Trim($profession) != "")
      { 
        $query_insert = "Insert into `profession` (`Profession`) 
               VALUES ('$profession')
               ";
     ...
     case 'Delete':
      {
       $query_delete = "DELETE FROM `profession` WHERE `Profession` = '$profession';";
