...
$sql="SELECT `ID`,`Office` FROM `office` WHERE `ID`='$ID'";
...
<form action="submitoffice.php" method="post">
<p><b><font face="Verdana" color="#008000" style="font-size: 16pt">Judges Offices Update</font></b></p>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="table2" height="70">
    <tr>
      <td width="17%" height="28">
        <font face="Verdana" style="font-size: 9pt">Office ID:
      </font>
      </td>
    ...
    <tr>
      <td width="17%" height="28">
        <font face="Verdana" style="font-size: 9pt">Office:
      </font>
      </td>
      <td width="34%" height="28">
        <span style="font-size: 9pt">
        <input type="text" name="office" size="31" value="<?php echo $row['Office']; ?>">
      	</span>
      </td>
      <td width="1%" height="28"></td>
     </tr>
