...
$sql="SELECT `AllowanceID`,`Type`,`Description`,`SortOrder`,`Group` FROM `allowance types` WHERE `AllowanceID`='$ID'";
...
<form action="submitallowtype.php" method="post">
<p><b><font face="Verdana" color="#008000" style="font-size: 16pt">Allowance Types Update</font></b></p>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="table2" height="70">
    <tr>
      <td width="17%" height="28">
        <font face="Verdana" style="font-size: 9pt">Allowance ID:
      </font>
      </td>
      <td width="31%" height="28">
        <font face="Verdana"><span style="font-size: 9pt">
        <input type="text" name="allowanceid" size="31" value="<?php echo $row['AllowanceID']; ?>">
      	</span></font>
      </td>
    ...
    <tr>
      ...
      <td width="1%" height="28"></td>
      <td width="17%" height="28">
        <font face="Verdana" style="font-size: 9pt">Sort Order:
      </font>        
      </td>
      <td width="34%" height="28">
        <font face="Verdana"><span style="font-size: 9pt">
        <input type="text" name="sortorder" size="31" value="<?php echo $row['SortOrder']; ?>">
      	</span></font>
      </td>
    </tr>
    <tr>
      <td width="17%" height="28">
        <font face="Verdana" style="font-size: 9pt">Group
      </font>
      </td>
      <td width="34%" height="28">
        <span style="font-size: 9pt">
        <input type="text" name="group" size="31" value="<?php echo $row['Group']; ?>">
      	</span>
      </td>
     </tr>
