...
$sql="SELECT `Position`, `Position SortOrder` FROM `position` WHERE `Position`='$ID'";
...
<p><b><font face="Verdana" color="#008000" style="font-size: 16pt">Position Update</font></b></p>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="table2" height="70">
    <tr>
      <td width="17%" height="28">
        <font face="Verdana" style="font-size: 9pt">Position:
      </font>
      </td>
    ...
    <tr>
      ...
      <td width="34%" height="28">
        ...
        <input type="text" name="sortorder" size="31" value="<?php echo $row['Position Sortorder']; ?>">
      	</span>
      </td>
      <td width="1%" height="28"></td>
     </tr>
