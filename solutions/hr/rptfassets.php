...
if (!isset($_SESSION['USER_ID']) & ($_SESSION['access_lvl'] != 5)  & ($_SESSION['access_lvl'] != 6) & ($_SESSION['access_lvl'] != 5))
{
 ...
 echo "<p>";
  ...
  if ($cmbFilter !="" & $cmbFilter !="All")
  {
   ...
   { 
    ...
    while(list($id,$code,$location,$category,$name,$quantity,$status, $serialno)=mysql_fetch_row($result))
    {
