		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="" class="logo">
						<img src="../images/logo.jpg" height="35" alt="THRIFT MANAGEMENT" />
					</a>
				...
				<span align="center"><font style="font-size:28px;margin-left:20%">FINASOL</font></span> &nbsp;
                                <span align="center" class="role"> <i>(A COOPERATIVE MANAGEMENT SOFTWARE)</i> </span>
					...
					<div id="userbox" class="userbox">
						...
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="../assets/images/logg.jpg" alt="Joseph Doe" class="img-circle" data-lock-picture="assets/images/!logged-user.jpg" />
							</figure>
...
?>
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<li>
												<a href="../backmeup.php">BackUp/Reset</a>
											</li>
										</ul>
									</li>
<?php
