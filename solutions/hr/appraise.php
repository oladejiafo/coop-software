...
$sql="SELECT `Staff Number`,`Reference`,`Period`,`Description` FROM `appraisal` WHERE `Reference`='$RNO'";
...
<p><b><font face="Verdana" color="#008000" style="font-size: 16pt">Appraisal Update</font></b></p>
<div align="left">
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="table2" height="70">
    ...
    <tr>
      <td width="17%" height="28">
        <font face="Verdana" style="font-size: 9pt">Period
      </font>
      </td>
      <td width="31%" height="28">
        <font face="Verdana"><span style="font-size: 9pt">
        <input type="text" name="period" size="31" value="<?php echo $row['Period']; ?>">
      	</span></font>
      </td>
      <td width="1%" height="28"></td>
      <td width="17%" height="28">
...
<?php 
 echo "<a href='appraisal.php?SNO=" . $row['Staff Number'] . "'>Click here</a> to return to list.";
