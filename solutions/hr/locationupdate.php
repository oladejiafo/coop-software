...
$sql="SELECT `Location_ID`,`Location` FROM `location` WHERE `Location_ID`='$ID'";
...
<p><b><font face="Verdana" color="#008000" style="font-size: 16pt">Office Location Update</font></b></p>
