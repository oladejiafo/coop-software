...
<p><legend><b><i><font size="2" face="Tahoma" color="#008000"> <?php require_once 'acctheader.php'; ?>
   ...
   <form  action="dailycash.php" method="post">
    <body bgcolor="#D2DD8F">
      <font style='font-size: 8pt'>Enter Date [Format: yyyy-mm-dd]: 
...
<?php
 ...
 $filter=$_REQUEST["filter"];
   ...
   echo " <tr><b> [Daily Cash Report]</b><br></tr>";
   echo "<TR bgcolor='#008000'><TH><b> Type </b>&nbsp;</TH><TH><b> Category </b>&nbsp;</TH><TH><b> Details </b>&nbsp;</TH><TH><b> Date </b>&nbsp;</TH><TH><b> Amount </b>&nbsp;</TH></TR>";
 
   $result = mysql_query ("SELECT `Type`,`Classification`,`Particulars`, `Date`, `Amount` FROM `cash` where `Date` like '" . $filter . "%' LIMIT $limitvalue, $limit"); 
   ...
   $res = mysql_query ("SELECT sum(`Amount`) as amt From `cash` where `Date` like '$filter%'");
