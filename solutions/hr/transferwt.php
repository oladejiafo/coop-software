<?php
  echo "<TR bgcolor='#009900'><TH colspan='1'> &nbsp;</TH><TH colspan='2'><b>TRANSFERED </b>&nbsp;</TH><TH colspan='6'>&nbsp;</TH></TR>";
  echo "<TR bgcolor='#999999'><TH><b>S/No </b>&nbsp;</TH><TH><b>From </b> &nbsp;</TH><TH><b>To </b>&nbsp;</TH>
      <TH><b>Post </b>&nbsp;</TH><TH><b>State of Origin </b>&nbsp;</TH><TH><b>LGA </b>&nbsp;</TH><TH><b>Male </b>&nbsp;</TH><TH><b>Female </b>&nbsp;</TH><TH> Total </b>&nbsp;</TH></TR>";
...
$sn=0;
    while(list($ploc,$vloc,$rank,$state,$lga,$gl,$sex)=mysql_fetch_row($result))
    {
     ...
     $xt=$xf+$xm;
     echo "<TR><TH> $sn &nbsp;</TH><TH>$vloc &nbsp;</TH><TH>$ploc &nbsp;</TH><TH>$rank &nbsp;</TH><TH>$state &nbsp;</TH><TH>$lga &nbsp;</TH><TH>$xm &nbsp;</TH><TH>$xf &nbsp;</TH><TH>$xt &nbsp;</TH></TR>";
    }
#####################Grand Total
