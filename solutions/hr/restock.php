...
<TABLE width='90%' border='1' cellpadding='1' cellspacing='1' align='center' bordercolor="#005B00" id="table2">
 ...
 echo "<p><font style='font-size: 9pt'>";
    ...
    echo "<b>[RESTOCK LIST for product - <i>" . $row['Stock Name'] . ", " . $row['Category'] . "</i>]</b><br>";

    echo "<TR><TH><b><u>Restock Date </b></u>&nbsp;</TH><TH><b><u>Quantity Added </b></u>&nbsp;</TH><TH><b><u>Received By </b></u>&nbsp;</TH>
          <TH><b><u>Supplied By </b></u>&nbsp;</TH><TH><b><u>Location </b></u>&nbsp;</TH></TR>";

   $query_count    = "SELECT * FROM `restock` WHERE `Stock Code`='$code'"; 
   ...
   $query="SELECT `ID`,`Stock Code`,`Stock Date`,`Qnty Added`,`Received By`,`Supplier`,`Location` FROM `restock` WHERE `Stock Code`='$code' order by `Stock Date` Desc LIMIT $limitvalue, $limit";
   ...
   { 
    ...
    while(list($id,$code,$dates,$added,$recby,$suppby,$loc)=mysql_fetch_row($result))
    {
     echo "<TR><TH><a href = 'restockupdate.php?code=" . $code . "&id=" . $id . "'>$dates </a> &nbsp;</TH><TH> $added  &nbsp;</TH><TH>$recby &nbsp;</TH>
           <TH>$suppby &nbsp;</TH><TH>$loc &nbsp;</TH></TR>";
    }
...
<TABLE width='30%' border='1' cellpadding='1' cellspacing='0' align='center' bordercolor="#005B00" id="table6">
  ...
  <?php
     echo "<br><TR>
               <TH><a href ='restockupdate.php?code=" . $sn . "&id=" . $id . "'> Add New Record </a>&nbsp;</TH><br>
           </TR>"; 
  ?>
