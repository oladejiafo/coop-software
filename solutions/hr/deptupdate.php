...
$sql="SELECT `Dept ID`,`Dept` FROM `department` WHERE `Dept ID`='$ID'";
...
<p><b><font face="Verdana" color="#008000" style="font-size: 16pt">Department Update</font></b></p>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="table2" height="70">
    <tr>
      <td width="17%" height="28">
        <font face="Verdana" style="font-size: 9pt">Department ID:
      </font>
      </td>
      <td width="31%" height="28">
        <font face="Verdana"><span style="font-size: 9pt">
        <input type="text" name="deptid" size="31" value="<?php echo $row['Dept ID']; ?>">
      	</span></font>
      </td>
    ...
    <tr>
      <td width="17%" height="28">
        <font face="Verdana" style="font-size: 9pt">Department:
      </font>
      </td>
      <td width="34%" height="28">
        <span style="font-size: 9pt">
        <input type="text" name="department" size="31" value="<?php echo $row['Dept']; ?>">
      	</span>
      </td>
      <td width="1%" height="28"></td>
     </tr>
