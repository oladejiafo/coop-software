...
<TABLE width='820' border='1' cellpadding='1' cellspacing='1' align='center' id="table3">
...
<?php
 ...
 $filter=$_REQUEST["filter"];
  ...
  echo"<h2><center>Summary Sheet</center></h2> ";
 ...
 echo "<TR><TH align='left' width='30%'> <font style='font-size: 9pt'><b>Total Deduction </b></font>&nbsp;</TH><TH align='right' width='20%'><font style='font-size: 9pt'>$td</font>&nbsp;</TH></TR>";
  ...
  $np=number_format($np,2);
   ...
   echo "<TR><TH>&nbsp;</TH></TR>"; 
   echo "<TR><TH width='33%' bgcolor='#EAEAEA' align='left'><font style='font-size: 9pt'><b>Total</b></font></TH><TH width='20%' bgcolor='#EAEAEA' align='right'><font style='font-size: 9pt'><b>$np</b></font></TH></TR><p>";
...
<?php
 echo "<a target='blank' href='rptsummarysheet.php?filter=$filter'> Print This Summary</a> &nbsp; ";
?>
</td>
</tr>
</Table
