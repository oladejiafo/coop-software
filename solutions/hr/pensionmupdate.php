...
$sql="SELECT `Code`,`Pension Managers`, `Address` FROM `pension managers` WHERE `Code`='$ID'";
...
<form action="submitpensionman.php" method="post">
<p><b><font face="Verdana" color="#008000" style="font-size: 16pt">Pension Managers Update</font></b></p>
...
<div align="left">
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="table2" height="70">
    ...
    <tr>
      <td width="17%" height="28">
        <font face="Verdana" style="font-size: 9pt">Pension Managers:
      </font>
      </td>
      <td width="34%" height="28">
        <span style="font-size: 9pt">
        <input type="text" name="pensionmanagers" size="31" value="<?php echo $row['Pension Managers']; ?>">
      	</span>
      </td>
      <td width="1%" height="28"></td>
     </tr>
