...
<p><legend><b><i><font size="2" face="Tahoma" color="#008000"> <?php require_once 'acctheader.php'; ?>
   ...
   <form  action="yearlycash.php" method="post">
    <body bgcolor="#D2DD8F">
      <font style='font-size: 8pt'>Enter Year[Format: 2004]: 
...
<?php
 ...
 $filter=$_REQUEST["filter"];
   ...
   echo " <tr><b> [Yearly Cash Report]</b><br></tr>";
