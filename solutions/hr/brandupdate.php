...
$sql="SELECT `ID`,`Brand Name` FROM `brand` WHERE `ID`='$ID'";
...
<form action="submitbrand.php" method="post">
<p><b><font face="Verdana" color="#008000" style="font-size: 14pt"><u>Brand Name Update</u></font></b></p>
...
<div align="left">
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="table2" height="70">
    ...
    <tr>
      <td width="7%" height="28">
        <font face="Verdana" style="font-size: 9pt">Brand Name:
      </font>
      </td>
      <td width="34%" height="28">
        <span style="font-size: 9pt">
        <input type="text" name="brand" size="31" value="<?php echo $row['Brand Name']; ?>">
      	</span>
      </td>
      <td width="1%" height="28"></td>
     </tr>
