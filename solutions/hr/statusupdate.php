...
$sql="SELECT `Status` FROM `status` WHERE `Status`='$ID'";
...
<p><b><font face="Verdana" color="#008000" style="font-size: 16pt">Status Update</font></b></p>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="table2" height="70">
    <tr>
      <td width="17%" height="28">
        <font face="Verdana" style="font-size: 9pt">Status:
      </font>
      </td>
      <td width="31%" height="28">
        <font face="Verdana"><span style="font-size: 9pt">
        <input type="text" name="stat" size="31" value="<?php echo $row['Status']; ?>">
      	</span></font>
      </td>
