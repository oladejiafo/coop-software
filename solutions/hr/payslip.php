...
?>
   ...
   <form  action="payreports.php" method="post">
    <body bgcolor="#D2DD8F">
      <font style='font-size: 8pt'>Select Printing Option: <select style="width:150px;height:35px" name="cmbFilter">
      <option Selected>Individual</option>
      <option >All Staff</option>
     </select></font>
     &nbsp; 
      <font style='font-size: 8pt'>Enter Staff Number: 
      <input type="text" name="filter" style="width:150px;height:35px"></font>
      <input type="hidden" name="cmbReport" size="15" value="Payslip"></font>
      &nbsp;
      <input type="submit" value="Generate" name="submit" style="width:120px;height:35px">
     <br>
    </body>
   </form>
