...
<img src='images/<?php echo $cpfolder;?>/logo.jpg' width='190' height='140'></td></tr><tr><td width='460'><font style='font-size: 13pt'><b><?php echo $addy; ?></b>
</font></td></tr>
...
<TABLE width='100%' border='1' cellpadding='1' cellspacing='1' align='center' bordercolor="#ccCCcc" id="table2">
 <?php
   ...
   $result = mysqli_query ($conn,"SELECT distinct `Category` FROM `heads` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Category` not in ('Fixed Assets','Current Assets','Current Liabilities') LIMIT $limitvalue, $limit"); 
