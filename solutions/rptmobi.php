...
$qry = "SELECT distinct `Agent` FROM `contributions` WHERE `Company` ='" .$_SESSION['company']. "'";
...
while(list($agent)=mysqli_fetch_row($reslt))
{
  ...
  {  
   $query_count = "SELECT * FROM `contributions` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Agent` like '" . $agent . "%' and `Date`='" . date('Y-m-d') . "'";
   $query_tot = "SELECT * FROM `contributions` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Agent` like '" . $agent . "%'";
   $query_new = "SELECT * FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Officer` like '" . $agent . "%' and `Date Registered`='" . date('Y-m-d') . "'";
   $query_pr = "SELECT distinct `Account Type` FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Officer` like '" . $agent . "%'";
  }
  else if ($cmbFilter=="Entered By")
  {  
   $query_count = "SELECT * FROM `contributions` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Agent` like '" . $agent . "%' and `Entered By` like '%" . $filter . "%' and `Date`='" . date('Y-m-d') . "'";
   $query_tot = "SELECT * FROM `contributions` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Agent` like '" . $agent . "%'";
   $query_new = "SELECT * FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Officer` like '" . $agent . "%' and `Date Registered`='" . date('Y-m-d') . "'";
   $query_pr = "SELECT distinct `Account Type` FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Officer` like '" . $agent . "%'";
  }
  ...
  {  
   $query_count = "SELECT * FROM `contributions` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Agent` like '" . $agent . "%' and `Pay Mode` ='Cash' and `Date`='" . date('Y-m-d') . "'";
   $query_tot = "SELECT * FROM `contributions` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Pay Mode` ='Cash' and `Agent` like '" . $agent . "%'";
   $query_new = "SELECT * FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Officer` like '" . $agent . "%' and `Date Registered`='" . date('Y-m-d') . "'";
   $query_pr = "SELECT distinct `Account Type` FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Officer` like '" . $agent . "%'";
  }
  else if ($cmbFilter=="Cheque")
  {  
   $query_count = "SELECT * FROM `contributions` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Agent` like '" . $agent . "%' and `Pay Mode` ='Cheque' and `Date`='" . date('Y-m-d') . "'";
   $query_tot = "SELECT * FROM `contributions` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Pay Mode` ='Cheque' and `Agent` like '" . $agent . "%'";
   $query_new = "SELECT * FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Officer` like '" . $agent . "%' and `Date Registered`='" . date('Y-m-d') . "'";
   $query_pr = "SELECT distinct `Account Type` FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Officer` like '" . $agent . "%'";
  }
  else if ($cmbFilter=="Date Range")
  {  
   $query_count = "SELECT * FROM `contributions` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Agent` like '" . $agent . "%' and  and (`Date` between '" . $filter . "' and '" . $filter2 . "')";
   $query_tot = "SELECT * FROM `contributions` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Pay Mode` ='Cheque' and `Agent` like '" . $agent . "%'";
   $query_new = "SELECT * FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Officer` like '" . $agent . "%' and (`Date Registered` between '" . $filter . "' and '" . $filter2 . "')";
   $query_pr = "SELECT distinct `Account Type` FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Officer` like '" . $agent . "%'";
  }
