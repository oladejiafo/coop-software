...
$sql="SELECT `ID`,`Bank` FROM `bank` WHERE `Company` ='" .$_SESSION['company']. "' AND  `ID`='$ID'";
...
<p><b><font face="Verdana" color="#87ceff" style="font-size: 16pt">Bank Update</font></b></p>
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="99%" id="table2" height="70">
    <tr>
      ...
      <td width="34%" height="28">
        <font face="Verdana"><span style="font-size: 9pt">
        <input type="text" name="bank" size="31" value="<?php echo $row['Bank']; ?>">
      	</span></font>
      </td>
    </tr>
  </table>
