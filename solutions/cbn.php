...
<TABLE width='100%' border='1' cellpadding='1' cellspacing='1' align='center' bordercolor="#005B00">
 ...
 @$limit      = 20;
 @$page=$_GET['page'];
 @$query_count    = "SELECT * FROM `remitance` WHERE `Company` ='" .$_SESSION['company']. "'";     
 ...
 $limitvalue = $page * $limit - ($limit);  
    ...
    $query="SELECT `Bank Date`,Bank,`Bank Remitance`,`ID`,`Bank Confirm`,`CBN Confirm` FROM `remitance` WHERE `Company` ='" .$_SESSION['company']. "' order by `Bank` LIMIT $limitvalue, $limit";
