...
<form  action="report.php" method="POST">
 ...
 <tr><td>
  ...
  <input type="text" id="inputFieldA" name="filter" value="2015-01-01" style="width:120px;height:30px">
   <input type="hidden" name="cmbReport" size="12" value="Loan Provisions Report">
 </td>
 <td>
  Enter Date Range (Ending): 
   <input type="text" id="inputFieldB" name="filter2" value="2015-12-31" style="width:120px;height:30px">
 </td>
<td> 
...
<?php
   ...
   $query="SELECT `Date`,`Recipient`,`Classification`,`Amount`,`Particulars` FROM `cash` WHERE `Company` ='" .$_SESSION['company']. "' AND  (`Date` between '$filter' and '$filter2') and `Classification` in ('General Reserves','Specific Reserve for Performing Loans (0 day)', 'Specific Reserve for Pass and Watch Loans (1-30 days)','Specific Reserve for Substandard Loans (31-60 days)','Specific Reserve for Doubtful Loans (61-90 days)','Specific Reserve for Lost Loans (>91 days)') group by `Recipient`,`Date` order by `Date` desc";
