...
<?php
   ...
   $queryWK="SELECT `Loan Date`,sum(`Loan Amount`) as dl FROM `loan` where `Loan Status`='Active'
             AND  (DATE( `Loan Date` ) >= DATE_ADD( '2019-04-05 00:00:00', INTERVAL -1 WEEK)) 
             GROUP BY `Loan Date`";
...
?>
      ...
      var options = {
        title: "Daily Loan... Total: <?php echo $dw; ?>",
...
<div class="chart" id="wkchart_values" style=" background-color:#EFEFEF; width: 95%; height: 46%;">
