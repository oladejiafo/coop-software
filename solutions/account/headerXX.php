...
?>
							<li class="dropdown">
								...
								<ul class="dropdown-menu agile_short_dropdown">
									<li style="text-align:left; margin-left:5px; margin-bottom:10px"><a href="account.php"><font style="font-size:11px">Entry Journal</font></a></li>
									<li style="text-align:left; margin-left:5px; margin-bottom:10px"><a href="suspense.php"><font style="font-size:11px">Suspense Accounts</font></a></li>
									<li style="text-align:left; margin-left:5px; margin-bottom:10px"><a href="provisions.php"><font style="font-size:11px">Loans Provisions</font></a></li>
									<li style="text-align:left; margin-left:5px; margin-bottom:10px"><a href="fassets.php"><font style="font-size:11px">Fixed Assets</font></a></li>
									<li style="text-align:left; margin-left:5px; margin-bottom:10px"><a href="contract.php"><font style="font-size:11px">Contractors</font></a></li>
									<li style="text-align:left; margin-left:5px"><a href="paysumm.php"><font style="font-size:11px">Payment Summary</font></a></li>
								 </ul>	
							</li>
<?php
            }
