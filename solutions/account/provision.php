...
$sql="SELECT * FROM `cash` WHERE `Company` ='" .$_SESSION['company']. "' AND  `ID`='$id' and `Classification` = '$class' and `Date`='$date' order by `Date` desc";
...
<form action="submitprovision.php" method="post">
<div align="center">
<div align="leftt" style="margin-left:20px;font-size: 12px" class="agileinfo_mail_grids">
	...
	<select  name="type"  class="input__field input__field--chisato" placeholder=" " value="<?php echo $row['Type']; ?>" required>  
          <?php  
	...
	<select  name="classification" class="input__field input__field--chisato" placeholder=" " value="<?php echo $row['Classification']; ?>" required>  
          <?php  
           ...
           $sql = "SELECT * FROM `heads` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Code` like '45%'";
	...
	<select  name="source"  class="input__field input__field--chisato" placeholder=" " value="<?php echo $row['Source']; ?>">  
      ...
      <span class="input input--chisato">
	<label class="input__label input__label--chisato">
		<span style="margin-left:10px" class="input__label-content input__label-content--chisato">Customer's Name:</span>
	</label>
 	<input type="text" name="recipient"  class="input__field input__field--chisato" placeholder=" " value="<?php echo $row['Recipient']; ?>">
      </span>
      <span class="input input--chisato">
	<label class="input__label input__label--chisato">
		<span style="margin-left:10px" class="input__label-content input__label-content--chisato">Customer's Account #:</span>
	</label>
...
<div>
<?php 
 echo "<a href='provisions.php'>Click here</a> to return to list.";
?>
</div>
<?php
