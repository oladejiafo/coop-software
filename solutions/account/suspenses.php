...
$sql="SELECT * FROM `cash` WHERE `Company` ='" .$_SESSION['company']. "' AND  `ID`='$id' and `Date`='$date' order by `Date` desc";
    ...
    font-size:12px;
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Suspense Item Account</h2>
					
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								<li>
									<a href="suspenses.php">
...
<div align="leftt" style="margin-left:20px;font-size: 12px" class="agileinfo_mail_grids">
	...
	<select  name="classification"  class="input__field input__field--chisato" placeholder=" " value="<?php echo $row['Classification']; ?>" required>  
          <?php  
           ...
           $sql = "SELECT * FROM `heads` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Code` like '581%'";
