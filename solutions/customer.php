...
if (!$acctno)
{
 $sql="SELECT * FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Account Number`='$code'";
 #$sql="SELECT * FROM stock WHERE `Company` ='" .$_SESSION['company']. "' AND  `Stock Code` = '$code'";
 $codd=empty($codd);
} else {
...
<title>Customer Service | Cooperatives Management Software</title>
	...
	<label class="input__label input__label--chisato">
        ...
        <select class="input__field input__field--chisato" placeholder=" " name="code" width="31" style="height:45px;width:300px;color:#000">  
          <?php  
           ...
           {
             $sql = "SELECT `Account Number`,`Surname`,`First Name` FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `First Name` like '%$acctno%' or `Surname` like '%$acctno%' or `Contact Number` like '%$acctno%' order by `Account Number`";
...
<legend><b><i><font size="2" face="Tahoma" color="green">Account Information</font></i></b></legend>
	...
	<label class="input__label input__label--chisato">
       ...
       <input type="text" name="idexp"  class="input__field input__field--chisato" placeholder=" " value="<?php echo $row['ID Expiration']; ?>" readonly="readonly" style="background-color:#eeeeee">
      </span>
      <span class="input input--chisato">
	<label class="input__label input__label--chisato">
...
<span>
	 <?php  if (file_exists("images/pics/" .$cpfolder. "/" . $id . "x1.jpg")==1)
            { ?>
              <img border="1" src="images/pics/<?php echo $cpfolder;?>/<?php echo $id; ?>x1.jpg" width="100" height="120">
	 <?php  } else { ?>
...
<div style="vertical-align:bottom">
<span>
	 <?php  if (file_exists("images/sign/" .$cpfolder. "/" . $id . "x1.jpg")==1)
            { ?>
              <img border="1" src="images/sign/<?php echo $cpfolder;?>/<?php echo $id; ?>x1.jpg" width="140" height="90">
	 <?php  } else { ?>
...
<div style="vertical-align:bottom">
<span>
	 <?php  if (file_exists("images/pics/" .$cpfolder. "/" . $id . "x2.jpg")==1)
            { ?>
              <img border="1" src="images/pics/<?php echo $cpfolder;?>/<?php echo $id; ?>x2.jpg" width="100" height="120">
	 <?php  } else { ?>
              <img border="1" src="images/pics/pix.jpg" width="100" height="120">	 
	 <?php  } ?>			 
</span>
...
<div style="vertical-align:bottom">
<span>
	 <?php  if (file_exists("images/sign/" .$cpfolder. "/" . $id . "x2.jpg")==1)
            { ?>
              <img border="1" src="images/sign/<?php echo $cpfolder;?>/<?php echo $id; ?>x2.jpg" width="140" height="90">
	 <?php  } else { ?>
              <img border="1" src="images/sign/sign.jpg" width="140" height="90">	 
	 <?php  } ?>			 
</span>
...
<div style="vertical-align:bottom">
<span>
	 <?php  if (file_exists("images/pics/" .$cpfolder. "/" . $id . "x3.jpg")==1)
            { ?>
              <img border="1" src="images/pics/<?php echo $cpfolder;?>/<?php echo $id; ?>x3.jpg" width="100" height="120">
	 <?php  } else { ?>
              <img border="1" src="images/pics/pix.jpg" width="100" height="120">	 
	 <?php  } ?>			 
</span>
...
<div style="vertical-align:bottom">
<span>
	 <?php  if (file_exists("images/sign/" .$cpfolder. "/" . $id . "x3.jpg")==1)
            { ?>
              <img border="1" src="images/sign/<?php echo $cpfolder;?>/<?php echo $id; ?>x3.jpg" width="140" height="90">
	 <?php  } else { ?>
              <img border="1" src="images/sign/sign.jpg" width="140" height="90">	 
	 <?php  } ?>			 
</span>
...
<div style="vertical-align:bottom">
<span>
	 <?php  if (file_exists("images/pics/" .$cpfolder. "/" . $row['ID'] . ".jpg")==1)
            { ?>
              <img border="1" src="images/pics/<?php echo $cpfolder;?>/<?php echo $row['ID']; ?>.jpg" width="100" height="120">
	 <?php  } else { ?>
              <img border="1" src="images/pics/pix.jpg" width="100" height="120">	 
	 <?php  } ?>			 
</span>
...
<div style="vertical-align:bottom">
<span>
	 <?php  if (file_exists("images/sign/" .$cpfolder. "/" . $row['ID'] . ".jpg")==1)
            { ?>
              <img border="1" src="images/sign/<?php echo $cpfolder;?>/<?php echo $row['ID']; ?>.jpg" width="140" height="90">
	 <?php  } else { ?>
              <img border="1" src="images/sign/sign.jpg" width="140" height="90">	 
	 <?php  } ?>			 
</span>
...
<legend><b><i><font size="2" face="Tahoma" color="green">Personal Information</font></i></b></legend>
	...
	<label class="input__label input__label--chisato">
        ...
        <input class="input__field input__field--chisato" placeholder=" " type="text" name="dependant" size="24" value="<?php echo $row['Dependant']; ?>" readonly="readonly" style="background-color:#eeeeee">
      </span>
      <span class="input input--chisato">
	<label class="input__label input__label--chisato">
	...
	<label class="input__label input__label--chisato">
       ...
       <input class="input__field input__field--chisato" placeholder=" " type="text" name="dob" size="24" value="<?php echo date('d-m-Y',strtotime($row['Date of Birth'])); ?>" readonly="readonly" style="background-color:#eeeeee">
      </span>
      <span class="input input--chisato">
	<label class="input__label input__label--chisato">
	...
	<label class="input__label input__label--chisato">
        ...
        <input type="text" class="input__field input__field--chisato" placeholder=" " name="state" value="<?php echo $row['State']; ?>"  readonly="readonly" style="background-color:#eeeeee">  
      </span>
      <span class="input input--chisato">
	<label class="input__label input__label--chisato">
		<span class="input__label-content input__label-content--chisato">BVN Number:</span>
	</label>
        <input class="input__field input__field--chisato" placeholder=" " type="text" name="bvn" size="24" value="<?php echo $row['BVN']; ?>" readonly="readonly" style="background-color:#eeeeee">  
      </span>
      <span class="input input--chisato">
	<label class="input__label input__label--chisato">
		<span class="input__label-content input__label-content--chisato">Other Bank Name:</span>
	</label>
        <input class="input__field input__field--chisato" placeholder=" " type="text" name="obank" size="24" value="<?php echo $row['Bank Name']; ?>" readonly="readonly" style="background-color:#eeeeee">  
      </span>
      <span class="input input--chisato">
	<label class="input__label input__label--chisato">
		<span class="input__label-content input__label-content--chisato">Other Bank Account Name:</span>
	</label>
        <input class="input__field input__field--chisato" placeholder=" " type="text" name="obankname" size="24" value="<?php echo $row['Bank Account Name']; ?>" readonly="readonly" style="background-color:#eeeeee">  
      </span>
      <span class="input input--chisato">
	<label class="input__label input__label--chisato">
		<span class="input__label-content input__label-content--chisato">Other Bank Account Number:</span>
	</label>
        <input class="input__field input__field--chisato" placeholder=" " type="text" name="obankno" size="24" value="<?php echo $row['Bank Account Number']; ?>" readonly="readonly" style="background-color:#eeeeee">  
      </span>
 </fieldset>
 <br>
<fieldset style="padding: 2">
...
$i=0;
    ...
    { 
      $sqlw="SELECT * FROM `customer` WHERE `Company` ='" .$_SESSION['company']. "' AND  `Account Number`='$acctno'";
